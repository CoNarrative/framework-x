export const evt = {
  ...
  START_EDIT_TODO: 'todo/start-edit',
  SET_EDIT_TODO_TEXT: 'todo/update-edit',
  SAVE_EDIT_TODO: 'todo/save-edit',


  TOGGLE_DONE: 'todo/toggle-done',
