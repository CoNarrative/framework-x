# ![Framework-X Example App](project-logo.png)
...
### [Demo](https://framework-x.realworld.io)&nbsp;&nbsp;&nbsp;&nbsp;[RealWorld](https://github.com/gothinkster/realworld)

The codebase is now feature complete; please submit bug fixes via pull requests & feedback via issues.

We also have notes in
[**our wiki**](https://github.com/gothinkster/framework-x-realworld-example-app/wiki)
about how the various patterns used in this codebase and how they work.


## Getting started

You can view a live demo over at https://framework-x.realworld.io/
...
including authentication. You can view a live demo over at
https://framework-x.productionready.io/
